package edu.unc.mapseq.ws.ncnexus38.demultiplex;
...
@WebService(targetNamespace = "http://demultiplex.ncnexus38.ws.mapseq.unc.edu", serviceName = "NCNEXUS38DemultiplexService", portName = "NCNEXUS38DemultiplexPort")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = SOAPBinding.ParameterStyle.WRAPPED)
@Path("/NCNEXUS38DemultiplexService/")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public interface NCNEXUS38DemultiplexService {
