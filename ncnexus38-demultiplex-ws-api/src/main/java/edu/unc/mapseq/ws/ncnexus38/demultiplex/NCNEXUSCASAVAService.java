...
@WebService(targetNamespace = "http://casava.ncnexus.ws.mapseq.unc.edu", serviceName = "NCNEXUSCASAVAService", portName = "NCNEXUSCASAVAPort")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = SOAPBinding.ParameterStyle.WRAPPED)
@Path("/NCNEXUSCASAVAService/")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public interface NCNEXUSCASAVAService {
