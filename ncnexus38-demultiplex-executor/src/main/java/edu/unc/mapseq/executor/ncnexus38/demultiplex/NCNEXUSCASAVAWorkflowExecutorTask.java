...
import edu.unc.mapseq.workflow.ncnexus38.demultiplex.NCNEXUSCASAVAWorkflow;

public class NCNEXUSCASAVAWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSCASAVAWorkflowExecutorTask.class);
    ...
    public NCNEXUSCASAVAWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCNEXUSCASAVAWorkflow casavaWorkflow = new NCNEXUSCASAVAWorkflow();
